...
const Client = (function() {
  ...
  const controller = {
    ...
    detectFeatures: function() {
      model.browserType = controller.detectBrowserType();
      model.browserPlatform = controller.detectBrowserPlatform();
      model.isMobile = controller.detectMobileBrowser();
      model.screenDimensions = view.detectScreenDimensions();
      model.userMediaSupport = view.checkUserMediaSupport();
      model.canvasSupport = view.checkCanvasSupport();
      model.xmlHttpRequestSupport = controller.checkXMLHttpRequestSupport();
